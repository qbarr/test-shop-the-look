...
## Custom feature: Shop the look

This repo includes a “Shop the look” implementation based on a `look` metaobject.

- Setup guide: [docs/shop-the-look.md](docs/shop-the-look.md)
